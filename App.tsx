...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-purple-900 to-slate-900 text-white font-poppins relative overflow-x-hidden">
      ...
      {/* Enhanced Floating AI Button - Always Visible */}
      {!isAIOpen && (
        <motion.div
        ...
        >
          ...
          >
            ...
            <div className="absolute inset-0 w-20 h-20 bg-purple-500/30 rounded-full animate-pulse-ring" style={{ animationDelay: '0.5s' }}></div>
